...
See the sample input files [`train.csv`](https://github.com/fg-research/lstm-ad-sagemaker/blob/master/data/training/train.csv) and [`valid.csv`](https://github.com/fg-research/lstm-ad-sagemaker/blob/master/data/training/valid.csv).
...
See [`notebook.ipynb`](https://github.com/fg-research/lstm-ad-sagemaker/blob/master/notebook.ipynb) for an example of how to launch a hyperparameter tuning job.
